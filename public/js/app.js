...
// NAVBAR
var navDesk = document.querySelector('#navDesk');
...
fetch('./MOCK_DATA.json').then(function (response) {
  ...
  // ELEMENTI DOM
  var catSrc = document.querySelector('#catSrc');
  var option = document.createElement('option');
  var placeSrc = document.querySelector('#placeSrc');
  var secProd = document.querySelector('#secProd');
  var inputSrc = document.querySelector('#inputSrc');
  var srcBtn = document.querySelector('.srcBtn');
  var select = document.querySelector('#select'); // let productElement=document.querySelector('.product-element');
  // FUNZIONI LANCIATE
  ...
  populateProd(products); // POPOLAZIONE DROPDOWN CATEGORIE

  function popolaDropCat() {
    var categories = Array.from(new Set(products.map(function (el) {
      return el.category;
    })));
    categories.forEach(function (el, i) {
      var option = document.createElement('option');
      option.setAttribute('value', "".concat(el));
      option.innerHTML = "".concat(el);
  ...
  function popolaDropPlace() {
    var places = Array.from(new Set(products.map(function (el) {
      return el.position;
    })));
  ...
  function populateProd(products) {
    ...
    products.forEach(function (el) {
      ...
      div.innerHTML = "\n        <div class=\"cardProduct my-5\">\n            <img src=\"/media/car.png\" alt=\"\"class=\"img-fluid mx-0\">\n            <h6 class=\"mt-2 ms-2\">".concat(el.product, "</h6>\n            <p class=\"mt-2 ms-2 fs-6 d-block mb-0\">\n            <i class=\"fa-solid fa-boxes-stacked\"></i>\n            ").concat(el.category, "\n            </p>\n            <small class=\"mt-2 ms-2 d-block\">\n            <i class=\"fa-solid fa-location-dot\"></i>\n            ").concat(el.position, "\n            </small>\n            <small class=\"mt-2 ms-2 d-block\">\n            ").concat(el.date, "\n            </small>\n            <small class=").concat(el.stat == "vendo" ? 'tagSell' : 'tagSearch', ">").concat(el.stat == "vendo" ? 'VENDO' : 'CERCO', "</small>\n            <small class=").concat(el.premium == "1" ? 'tagPrem' : '', ">").concat(el.premium == "1" ? 'PREMIUM' : '', "</small>\n            <small class=\"mt-2 ms-auto me-2 pb-3 text-end d-block fw-bold fs-4 c-green-2\">\n            ").concat(el.price, "\n            </small>\n          </div>\n        ");
      secProd.appendChild(div);
    });
  }

  function filter() {
    var selectedCategory = catSrc.value;
    var selectedPlace = placeSrc.value;
    var searchedProduct = inputSrc.value.toLowerCase(); // CREO ARRAY FILTRATO PER INPUT CATEGORIA E LUOGO

    var filteredProduct = products.filter(function (product) {
      return product.product.toLowerCase().includes(searchedProduct);
    }).filter(function (product) {
      return product.category === selectedCategory || selectedCategory == 'all';
    }).filter(function (product) {
      return product.position === selectedPlace || selectedPlace == 'all';
    });
    var filteredIDs = filteredProduct.map(function (product) {
      return product.id;
    });
  ...
  function showHideFilter(filteredIDs) {
    var productElement = document.querySelectorAll('.product-element');
    productElement.forEach(function (el) {
      var productId = Number(el.getAttribute('product-id'));
  ...
  function sortProducts() {
    ...
    switch (order) {
      case "cheaper":
        products.sort(function (a, b) {
          return Number(a.price.substring(1)) - Number(b.price.substring(1));
        });
        break;
  ...
  function orderDom() {
    ...
    productElement.forEach(function (el) {
      var productId = Number(el.getAttribute('product-id'));
      var orderIndex = products.findIndex(function (product) {
...
fetch('/MOCK_DATA.json').then(function (response) {
  ...
  //SET INTERVAL HEADER
  var counterTitle = document.querySelector('#counterTitle');
  ...
  titleInterval(0, counterTitle, "".concat(products.length)); // POPOLAZIONE DROPDOWN CATEGORIE
  ...
  var swiperWrap = document.querySelector('#swiperWrap');
  var currentYear = new Date().getFullYear().toString();
  var sorted = products.filter(function (el) {
    return el.date.includes(currentYear);
  }).sort(function (a, b) {
  ...
  function slider() {
    for (var i = 0; i < 6; i++) {
      ...
      div.innerHTML = "\n    \n    <div class=\"cardProd\">\n      <img src=\"/media/car.png\" alt=\"\" class=\"img-fluid mx-0\">\n      <h6 class=\"mt-2 ms-2\">".concat(sorted[i].product, "</h6>\n      <p class=\"mt-2 ms-2 fs-6 d-block mb-0\">\n      <i class=\"fa-solid fa-boxes-stacked\"></i>\n      ").concat(sorted[i].category, "\n      </p>\n      <small class=\"mt-2 ms-2 d-block\">\n      <i class=\"fa-solid fa-location-dot\"></i>\n      ").concat(sorted[i].position, "\n      </small>\n      <small class=\"mt-2 ms-2 d-block\">\n      ").concat(sorted[i].date, "\n      </small>\n      <small class=").concat(sorted[i].stat == "vendo" ? 'tagVendo' : 'tagCerco', ">").concat(sorted[i].stat == "vendo" ? 'VENDO' : 'CERCO', "</small>\n      <small class=").concat(sorted[i].premium == "PREMIUM" ? 'tagPremium' : '', ">").concat(sorted[i].premium == "PREMIUM" ? 'PREMIUM' : '', "</small>\n      <small class=\"mt-2 ms-auto me-2 pb-3 text-end d-block fw-bold fs-4 c-green-2\">\n      ").concat(sorted[i].price, "\n      </small>\n    </div>\n    ");
